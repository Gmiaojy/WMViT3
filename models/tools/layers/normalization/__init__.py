...
for file in os.listdir(norm_dir):
    ...
    if (
        ...
        module = importlib.import_module("tools.layers.normalization." + model_name)
...
from tools.layers.normalization.batch_norm import BatchNorm2d, BatchNorm1d, BatchNorm3d
from tools.layers.normalization.group_norm import GroupNorm
from tools.layers.normalization.instance_norm import InstanceNorm1d, InstanceNorm2d
from tools.layers.normalization.sync_batch_norm import SyncBatchNorm
from tools.layers.normalization.layer_norm import LayerNorm, LayerNorm2D
